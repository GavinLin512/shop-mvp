...
| - [ ] | 18 | `18-subscription-visibility` 本人隔離(`GET /subscriptions`)+ 會員訂閱歷史 + 後台訂閱清單/期末取消 [SHOULD] | 07, 14, 17 | #6, #9 |

> 任務編號(00–14)沿用 `plans/` 資料夾名稱;15–17 為新增。15 見 [`docs/adr/0011-stripe-provider-coexist.md`](../../docs/adr/0011-stripe-provider-coexist.md);16 見 [`plans/16-swagger/spec.md`](../../plans/16-swagger/spec.md);17 見 [`plans/17-frontend-demo/spec.md`](../../plans/17-frontend-demo/spec.md);18 見 [`plans/18-subscription-visibility/spec.md`](../../plans/18-subscription-visibility/spec.md)。「順序」欄為依賴拓樸後的建議實作順序。
